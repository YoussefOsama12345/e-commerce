...
PRODUCT_MODEL_ERRORS = {
  ...
  DIMENSIONS_LETTERS_ONLY:
    'Dimensions can only contain letters and spaces.',
...
PAYMENT_MODEL_ERRORS = {
  ...
  PAYMENT_DATE_LENGTH:
    'Payment date must be between 1 and 100 characters.',
  PAYMENT_DATE_LETTERS_ONLY:
    'Payment date can only contain letters and spaces.',
